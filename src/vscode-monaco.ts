import { editor, Selection as _Selection, IRange, Uri, Thenable } from "monaco-editor";
...
export class TextEditor {
  ...
  private _applyEdit(editBuilder: TextEditorEdit): Promise<void> {
    ...
    this.editor.getModel().pushEditOperations(this.editor.getSelections(), edits, (): _Selection[] => {
      return [];
    });
  ...
  applyEdit(edit: WorkspaceEdit, newSelections?: Selection[]): Thenable<void> {
    ...
    this.editor
      .getModel()
      .pushEditOperations(this.editor.getSelections(), TypeConverters.WorkspaceEdit.from(edit), (): _Selection[] => {
