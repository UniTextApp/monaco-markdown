...
let annotation1 = ["cancel", "overbrace", "bcancel", "underbrace", "xcancel", "not =", "sout", "boxed", "tag", "tag*"];
...
let spacing1 = ["kern", "mkern", "mskip", "hskip", "hspace", "hspace*", "phantom", "hphantom", "vphantom"];
...
let classAssignment1 = ["mathbin", "mathclose", "mathinner", "mathop", "mathopen", "mathord", "mathpunct", "mathrel"];
...
let size0 = ["Huge", "huge", "LARGE", "Large", "large", "normalsize", "small", "footnotesize", "scriptsize", "tiny"];
let style0 = ["displaystyle", "textstyle", "scriptstyle", "scriptscriptstyle", "limits", "nolimits", "verb"];
...
export let _c3 = Array.from(new Set([...verticalLayout2, ...binomialCoefficients2, ...fractions2, ...color2]));
